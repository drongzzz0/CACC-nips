...
- Strict ready: `false`
- Rows: `16` total, `0` blocker, `1` pending, `4` caveat, `11` ok.

| Severity | Row | Bucket | Release delta | Fallback delta | Status |
| --- | --- | --- | ---: | ---: | --- |
| pending | mmlu_pro/spp | pending | - | +0.0045 | direct_rerun_pending_fallback_available |
...
| caveat | gsm8k/spp | watch | +0.0222 | - | fresh_rerun_close_final_different_decomposition |
